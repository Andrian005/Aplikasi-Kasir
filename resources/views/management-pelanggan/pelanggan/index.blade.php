...
@push('page_script')
    <script>
        ...
        function view(id) {
            $.ajax({
                url: '{{ route('management-pelanggan.pelanggan.view') }}/' + id,
        ...
        function create() {
            $.ajax({
                url: '{{ route('management-pelanggan.pelanggan.create') }}',
                success: function (response) {
                    bootbox.dialog({
        ...
        function store() {
            ...
            $.ajax({
                url: '{{ route('management-pelanggan.pelanggan.store') }}',
                type: 'POST',
                dataType: 'JSON',
        ...
        function edit(id) {
            $.ajax({
                url: '{{ route('management-pelanggan.pelanggan.edit') }}/' + id,
                success: function (response) {
                    bootbox.dialog({
        ...
        function update(id) {
            ...
            $.ajax({
                url: '{{ route('management-pelanggan.pelanggan.update') }}/' + id,
                type: 'POST',
                dataType: 'JSON',
        ...
        function destroy(id) {
            alertDestroy().then((result) => {
                if (result) {
                    $.ajax({
                        url: '{{ route('management-pelanggan.pelanggan.delete') }}/' + id,
                        success: function (response) {
                            if (response.success) {
                                iziToast.success({
                                    title: 'Success',
